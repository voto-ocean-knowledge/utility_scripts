...
tgtdir=/data/complete_mission/SEA$glider/M$mission/ADCP
echo make directory on target if it does not already exist
ssh usrerddap@136.243.54.252 mkdir -p $tgtdir
echo ""
echo rsync data
rsync -v  /data/data_l0_pyglider/complete_mission/SEA$glider/M$mission/ADCP/adcp.nc  "usrerddap@136.243.54.252:$tgtdir"
echo Finished
