...
tgtdir=/media/data/data_dir/complete_mission/SEA$glider/M$mission/ADCP
echo make directory on target if it does not already exist
ssh erddapdata@13.51.101.57 mkdir -p $tgtdir
echo ""
echo rsync data
rsync -v  /data/data_l0_pyglider/complete_mission/SEA$glider/M$mission/ADCP/adcp.nc  "erddapdata@13.51.101.57:$tgtdir"
echo Finished