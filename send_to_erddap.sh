...
tgtdir=/media/data/complete_mission/SEA$glider/M$mission/timeseries
echo make directory on target if it does not already exist
ssh usrerddap@13.51.101.57 mkdir -p $tgtdir
echo ""
echo rsync data
rsync -v  /data/data_l0_pyglider/complete_mission/SEA$glider/M$mission/timeseries/mission_timeseries.nc  "usrerddap@13.51.101.57:$tgtdir"
echo Finished